...
<template>
    ...
    >
        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            ...
            >
                <div
                    class="text-sm text-center text-gray-500 dark:text-gray-400 sm:text-left"
                >
                ...
                <div
                    class="ml-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0"
                >
